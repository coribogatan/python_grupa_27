...
class AnimalPark:
    ...
    def add_animal(self, anim):
         ...
         #isiantance verifica daca anim este o instanta a unei clase care e ori Animal ori mosteneste Animal, ori mosteneste orice alta clasa care mosteneste Animal
...
print(dog1.name)
print(cat1.name)
print(anim1.name) # Generic from method from animals
